...
export default function CompanyInternshipDetailsScreen() {
  ...
  useEffect(() => {
    if (!id) {
      console.log("No internship ID provided, redirecting back")
      router.back()
      return
    }
    console.log("CompanyInternshipDetailsScreen mounted with ID:", id)
    console.log("Fetching internship details for company view")
  ...
  const fetchInternshipDetails = async () => {
    ...
    try {
      setIsLoading(true)
      console.log("Fetching internship details from internships table with ID:", id)
      
      // Ensure id is a string and trim any whitespace
      const internshipId = String(id).trim()
      ...
      console.log("Successfully fetched internship data:", internshipData)

      // Now fetch the company details separately
      ...
      // Prepare the full internship data
