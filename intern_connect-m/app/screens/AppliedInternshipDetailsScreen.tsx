...
export default function AppliedInternshipDetailScreen() {
  ...
  const fetchInternshipDetails = async () => {
    ...
    try {
      ...
      // First, get the internship ID from the application
      ...
      // Then fetch the internship details
      ...
      if (!internshipData) {
        console.error("No internship found for ID:", applicationData.internship_id)
      ...
      const fullInternshipData = {
        ...internshipData,
        company_name: companyData?.company_name || companyData?.full_name || 'Unknown Company'
      }
