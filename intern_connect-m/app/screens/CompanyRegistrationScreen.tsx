  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      showAlert(
        ...
        "Your company account has been created successfully. Please log in.",
        () => {
          router.push("/screens/CompanyLoginScreen");
        }
      );
    } catch (error: any) {
      showAlert(
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
            <View style={styles.titleContainer}>
              ...
              <Text style={styles.subtitle}>Shape the future by joining InternConnect today</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.securityTipContainer}>
                <Feather name="shield" size={20} color="#0077b5" />
                <Text style={styles.securityTipText}>
                  For company accounts, we strongly recommend using a unique password that is not used for any other services.
                </Text>
              </View>
              ...
              >
                {isLoading ? (
                  ...
                  <View style={styles.createAccountButtonContent}>
                    <Text style={styles.createAccountButtonText}>Create Company Account</Text>
                  </View>
                )}
              </TouchableOpacity>
              ...
              <View style={styles.loginContainer}>
                <Text style={styles.loginText}>Already have an account?</Text>
                  <TouchableOpacity onPress={() => router.push("/screens/CompanyLoginScreen")}>
